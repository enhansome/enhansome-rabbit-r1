...
> \[!NOTE]
> As of June 29, 2024, many of these projects are still in their infancy. The "r1\_escape" jailbreak will help you get Android 13 running on your r1 for now. Please consider contributing to other listed projects.
...
* [r1\_escape](https://github.com/RabbitHoleEscapeR1/r1_escape) ⭐ 430 | 🐛 63 | 🌐 Shell | 📅 2024-08-13 - A jailbreak tool for the Rabbit r1.
...
* [Rabbit R1 Launcher](https://github.com/Pinball3D/Rabbit-R1) ⭐ 76 | 🐛 4 | 🌐 Smali | 📅 2024-07-18 - An effort to adapt the Rabbit R1 Launcher for use across any Android device.
...
* [rabbitude-backend](https://github.com/KibbeWater/rabbitude-backend) ⭐ 6 | 🐛 0 | 🌐 Go | 📅 2024-10-04 - A Go-based backend meant to reimplement the r1's backend and API endpoints.
* [rabbitserver-go](https://github.com/KibbeWater/rabbitserver-go) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2024-08-30 - A simple WebSocket wrapper for the RabbitHole API.
* [rabbitude-hole](https://github.com/KibbeWater/rabbitude-hole) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2024-08-18 - Rabbithole replacement for the rabbitude launcher.
...
* [GSI tree](https://github.com/RabbitHoleEscapeR1/device_rabbit_r1) ⭐ 10 | 🐛 0 | 🌐 Makefile | 📅 2024-06-07 - A view of the Rabbit r1's device image / filesystem.
* [MS35774 Info](https://github.com/CORN-R1/ms35774) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2024-06-13 - Stepper motor driver details for the ms35774 (r1's camera motor).
